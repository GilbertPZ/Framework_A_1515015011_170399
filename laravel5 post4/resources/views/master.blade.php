    ...
    <body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Dosen <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                <li><a href="{{url('dossen')}}">Data Dosen</a></li>
                                <li class="divider"></li>
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Pengaturan <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                ...
                                <li class="divider"></li>
                                <li><a href="{{url('ruangann')}}">ruangan</a></li>
                                <li class="divider"></li>
       ...
       <nav class="navbar navbar-default navbar-fixed-bottom">
           <footer class="container">
               ...
               created by <a href="http://instagram.com/mkharis96">
               <span><i class="fa fa-instagram" style="color: #1da1f2"></i>@GilbertPZ17</span></a> <!--/   please dont delete this    -->
           </footer>
       </nav>
